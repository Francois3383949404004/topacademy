...
export default class HeadComponent extends Component {
    ...
    componentDidMount() {
        ...
        // LIGNE SUPPRIMÉE : hotjar.initialize... (plus besoin)
    }
    ...
    render() {
        ...
        return <>
            ...
            {/* --- NOUVEAU CODE CONTENTSQUARE (CORRIGÉ AVEC VOTRE ID) --- */}
            <Script 
                id="contentsquare-script" 
                src="https://t.contentsquare.net/uxa/fc5f54435d991.js" 
            />
            {/* --------------------------------------------------------- */}
            ...
            <Script id="tawktoscriptwrapper" dangerouslySetInnerHTML={{
                __html: `var Tawk_API=Tawk_API||{ }, Tawk_LoadStart=new Date();
                    ...
                    s1.async=true;
                    s1.src='https://embed.tawk.to/6963ad8d7c8bd319796ace51/1jemlrspv';
                    s1.charset='UTF-8';
